...
function ApiFunction(name) {
    return new Promise(function (resolve, reject) {
        ...
        xhr.onload = function (res) { return resolve(JSON.parse(res.currentTarget.responseText)); };
        xhr.onerror = function () { return reject(xhr.statusText); };
        xhr.send();
    });
}
var liveSearch = document.getElementById('live-search');
var result = document.querySelector('.rep');
var sequence$ = rxjs_1.fromEvent(liveSearch, 'input');
...
sequence$
    .pipe(operators_1.debounceTime(200), operators_1.map(function (e) {
    return e.target.value;
}), operators_1.switchMap(function (str) {
